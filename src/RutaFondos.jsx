      ...
      <div className="max-w-lg mx-auto px-4 py-6">
        ...
        <header className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 leading-none mt-0.5">Financiamiento público y privado · Chile</p>
            </div>
          </div>
          {step >= 0 && (
        ...
        {step === -1 && (
          <div className="space-y-5">
            ...
            <p className="text-xs text-center text-gray-400">Gratis · Sin registro · Montos y fechas referenciales 2026</p>
          </div>
        )}
        ...
        {done && !isMinor && (
          <div className="space-y-6">
            ...
            <div className="rounded-2xl px-4 py-3 text-xs text-gray-500" style={{ backgroundColor: "#EDEBE6" }}>
              <strong>Última verificación de convocatorias:</strong> {ULTIMA_VERIFICACION}. Montos, fechas y requisitos son referenciales a 2026 y cambian por convocatoria y región. Antes de postular, revisa siempre las bases oficiales en el link de cada fondo. Postular es gratis: desconfía de quien cobre por "gestionar" tu postulación ante instituciones públicas. Esta herramienta orienta, no adjudica.
            </div>
